...
Qt/Rust application process
  Qt GUI thread
    QML controls, tabs, tooltips, popups, and BrowserSurface items
...
```sh
paru -S --needed at-spi2-core base-devel libx11 libdrm mesa mesa-utils openbox pkgconf protobuf python-gobject python-pillow qqc2-desktop-style qt6-base qt6-declarative xdotool xorg-xdpyinfo xorg-xprop
```
