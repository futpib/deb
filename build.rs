...
fn main() {
    ...
    for dependency in ["x11", "xcomposite", "xdamage", "xfixes", "gl"] {
        pkg_config::Config::new()
            .probe(dependency)
            .unwrap_or_else(|_| panic!("{dependency} development files are required"));
    }
    ...
    let generated = [
        (
            "src/native_window_factory.h",
            "moc_native_window_factory.cpp",
        ),
